...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoRender_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 50, 14)
    ...
    "VideoRender\0applyFullScreen\0\0VideoRender*\0"
    "pRender\0exitFullScreen\0"
};
...
void VideoRender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->applyFullScreen((*reinterpret_cast< VideoRender*(*)>(_a[1]))); break;
        case 1: _t->exitFullScreen((*reinterpret_cast< VideoRender*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoRender::*_t)(VideoRender * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoRender::applyFullScreen)) {
                *result = 0;
            }
        }
        {
            typedef void (VideoRender::*_t)(VideoRender * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoRender::exitFullScreen)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject VideoRender::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoRender.data,
      qt_meta_data_VideoRender,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoRender.stringdata))
...
// SIGNAL 0
void VideoRender::applyFullScreen(VideoRender * _t1)
{
...
// SIGNAL 1
void VideoRender::exitFullScreen(VideoRender * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
